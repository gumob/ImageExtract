...
//        self.measure {
//            XCTAssertNotNil(self.dataSet)
//            for data: DataSet.Image in self.dataSet.jpg {
//                let size: CGSize = ImageExtract.extract(data.url.withRandomQuery())
...
//        self.measure {
//            XCTAssertNotNil(self.dataSet)
//            for data: DataSet.Image in self.dataSet.png {
//                let size: CGSize = ImageExtract.extract(data.url.withRandomQuery())
//                XCTAssertEqual(data.size, size)
//            }
//        }
...
//        self.measure {
//            XCTAssertNotNil(self.dataSet)
//            for data: DataSet.Image in self.dataSet.gif {
//                let size: CGSize = ImageExtract.extract(data.url.withRandomQuery())
//                XCTAssertEqual(data.size, size)
//            }
//        }
...
//        self.measure {
//            XCTAssertNotNil(self.dataSet)
//            for data: DataSet.Image in self.dataSet.bmp {
//                let size: CGSize = ImageExtract.extract(data.url.withRandomQuery())
//                XCTAssertEqual(data.size, size)
//            }
//        }
...
////        self.measure {
////            XCTAssertNotNil(self.dataSet)
////            for data: DataSet.Image in self.dataSet.tif {
////                let size: CGSize = ImageExtract.extract(data.url.withRandomQuery())
////                XCTAssertEqual(data.size, size)
////            }
////        }
...
////        self.measure {
////            XCTAssertNotNil(self.dataSet)
////            for data: DataSet.Image in self.dataSet.webp {
////                let size: CGSize = ImageExtract.extract(data.url.withRandomQuery())
////                XCTAssertEqual(data.size, size)
////            }
////        }
